...
// Description: Fix any element on the page according to the options passed.You
//				can also add class to the element when it is fixed.It also trigger
//				events when element is "fixed" and "unfixed".
